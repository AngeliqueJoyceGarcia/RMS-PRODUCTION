        ...
        <form method="POST" action="{{ (route('rates.store')) }}" >
            ...
            <div class="Entrance-details">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="rate_name" name="rate_name" placeholder="Entrance Rate Name" required>
                </div>
                
                
                <div class="form-group">
                    <span class="Entrancedetails" for="baseChildPrice">Base Child Price:<span class="required">(Required)</span></span>
                    <input type="text" id="baseChildPrice" name="baseChildPrice" placeholder="Base Child Price" required>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="baseAdultPrice">Base Adult Price:<span class="required">(Required)</span></span>
                    <input type="text" id="baseAdultPrice" name="baseAdultPrice" placeholder="Base Adult Price" required>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="baseSeniorPrice">Base Senior Price:<span class="required">(Required)</span></span>
                    <input type="text" id="baseSeniorPrice" name="baseSeniorPrice" placeholder="Base Senior Price" required>
                </div>

                <div class="form-group">
                    <span class="Entrancedetails" for="vat">VAT %:<span class="required">(Required) </span></span>
                    <input type="text" id="vat" name="vat" placeholder="VAT (ex. 10)" required>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="servicecharge">Service Charge %:<span class="required">(Required)</span></span>
                    <input type="text" id="servicecharge" name="servicecharge" placeholder="Service Charge (ex. 10)"  required>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="vatsc_childprice">w/ VAT & SC Child:<span class="required">(Required)</span></span>
                    <input type="text" id="vatsc_childprice" name="vatsc_childprice" placeholder="VAT SC Child Price" required readonly>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="vatsc_adultprice">w/ VAT & SC Adult:<span class="required">(Required)</span></span>
                    <input type="text" id="vatsc_adultprice" name="vatsc_adultprice" placeholder="VAT SC Adult Price" required readonly>
                </div>
                
                <div class="form-group">
                    <span class="Entrancedetails" for="vatsc_seniorprice">w/ SC Senior/PWD:<span class="required">(Required)</span></span>
            ...
            <button class="EntranceButton" type="submit"> <span>Add</span></button>
            </form>
    </div>
...
<script>
                ...
                function calculatePrices() {
                    ...
                    // var baseSeniorPrice = (baseAdultPrice - (.20 * baseAdultPrice)).toFixed(3);
