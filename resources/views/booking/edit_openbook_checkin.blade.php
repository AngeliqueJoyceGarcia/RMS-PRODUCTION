...
<div class="body">
    ...
    <div class="popup-container" id="popupContainer">
      ...
      <form method="POST" action="{{ auth()->user()->role_id === 1 ? route('openbook.checkin_update', ['billing' => $billing->id]) : route('reguser.openbook.checkin_update', ['billing' => $billing->id]) }}">
        @csrf
        @method('PUT')
        <div class="user-details">
            ...
            <div class="form-group">
                    <span class="userdetails" for="pre_booking_amount">Arrived Companion:<span class="required">*</span></span>
                    <input type="number" name="arrived_companion" value="{{$billing->arrived_companion}}" min="0" max="{{$billing->total_companion}}">
            </div> 

            <div class="form-group">
                    <span class="userdetails" for="pre_booking_amount">Towel Subtotal:<span class="required"></span></span>
                    <input type="number" name="towel_subtotal" value="0" readonly>
            </div> 

            <div class="form-group">
                    <span class="userdetails" for="pre_booking_amount">Wristband Subtotal:<span class="required"></span></span>
                    <input type="number" name="wristband_subtotal" value="0" readonly>
            </div> 

            <div class="form-group">
                    <span class="userdetails" for="pre_booking_amount">Incidental Total Amount:<span class="required"></span></span>
                    <input type="number" name="towel_subtotal" value="{{$billing->refundablePrice }}" readonly>
            </div> 

            <div class="form-group">
                    <span class="userdetails" for="pre_booking_amount">Balance:<span class="required"></span></span>
                    <input type="number" name="wristband_subtotal" value="{{$billing->balance }}" readonly>
            </div> 

            <div class="form-group">
                    <span class="userdetails"for="incidental_amount">Check-in Payment:<span class="required">*</span></span>
            ...
            <br>
            <a href="{{ auth()->user()->role_id === 1 ?  route('openbook.checkin') : route('openbook.checkin') }}" class="UserButtonClose"><span>Cancel</span></a>
...
<script>
    ...
    function calculateAndSetSubtotals() {
        ...
        document.querySelector('input[name="towel_subtotal"]').value = TowelSubtotal;
        document.querySelector('input[name="wristband_subtotal"]').value = WristbandSubtotal;
    }
