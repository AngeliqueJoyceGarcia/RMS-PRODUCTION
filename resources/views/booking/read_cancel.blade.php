    ...
    <div class="upper">
        <div class="conbooking">
            <div class="containerBooking">
                <span>Canceled Booking Details</span>
            </div>
        </div>
        <div class="conbookingright">
            <div class="containerBookingcancel">
                <a class="archive" href="{{ auth()->user()->role_id === 1 ? route('booking.read') : route('reguserbooking.read') }}">Active Bookings</a>
            </div>
        </div>
    </div>
        <div class="searching">
        ...
        <div class="container">
            ...
            <div class="bookdetails">
                ...
                @if($booking->reservation_type == 'Walk-in' || $booking->reservation_type == 'Pre-book')
                ...
                @elseif($booking->reservation_type == 'Pre-book' || $booking->reservation_type == 'Open-book')
