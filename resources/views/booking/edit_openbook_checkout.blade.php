...
<div class="body">
    ...
    <div class="popup-container" id="popupContainer">
      ...
      <form method="POST" action="{{ auth()->user()->role_id === 1 ? route('openbook.checkout_update', ['billing' => $billing->id]) : route('reguser.openbook.checkout_update', ['billing' => $billing->id]) }}">
        @csrf
        @method('PUT')
        <div class="user-details">
            ...
            <br>
            <a href="{{ auth()->user()->role_id === 1 ?  route('openbook.checkout') : route('reguser.openbook.checkout') }}" class="UserButtonClose"><span>Cancel</span></a>
