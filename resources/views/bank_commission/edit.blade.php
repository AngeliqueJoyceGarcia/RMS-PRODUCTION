...
<div class="body">
    ...
    <div class="popup-container" id="popupContainer">
      ...
      <hr>
        <form action="{{ route('bankcom.update', ['bank' => $bank->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="bankname" name="bank_name" placeholder="Bank Name" required value="{{$bank->bank_name}}">
            </div> 

            <div class="form-group">
                    <span class="userdetails" for="bankcommission">Bank Commission Percentage:<span class="required">(Required)</span></span>
                    <input type="text" id="bankcommission" name="bank_commission_percentage" placeholder="Bank Commission %" required value="{{$bank->bank_commission_percentage}}">
            </div> 
