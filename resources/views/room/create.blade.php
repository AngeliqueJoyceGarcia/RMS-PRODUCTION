      ...
      <form action="{{ route('room.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="room-details">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="roomprice" name="roomprice"  placeholder="Room Price"required>
                            </div> 
                            
                            <div class="form-group">
                                <span class="roomdetails" for="roomcapacity">Capacity:<span class="required">(Required)</span></span>
                                <input type="number" id="roomcapacity" name="roomcapacity" placeholder="Room Capacity" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" id="roomdescription" name="roomdescription" rows= "6" placeholder="Room Description"required></textarea>
                            </div>
