    ...
    <div class="popup-container" id="popupContainer">
      ...
      <hr>
            ...
            <div class="form-group">
                ...
                <button class="genpass" type="button" id="generatePassword">Generate Password</button>
            </div>
            ...
            <div class="form-group">
                <label for="role_id" class="userdetails">Role:<span class="required">(Required)</span></label>
